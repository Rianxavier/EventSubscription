...
import br.com.nlw.events.exception.UserInficadorNotFoundExecption;
...
public class SubscriptionService {
    ...
    public SubscriptionResponse createNewSubscription(String eventName, User user, Integer userId) {
        ...
        if (userId != null) {
            ...
            if (indicador == null)
                throw new UserInficadorNotFoundExecption("Usuario " + userId + " indicador não existe");
        }
        ...
        return new SubscriptionResponse(subs.getSubscriptionNumber(), "http://codecraft.com/subscription/" + res.getEvent().getPrettyName() + "/" + res.getSubscriber().getId());
    }

    public List<SubscriptionRankingItem> getCompleteRanking(String prettyName) {
        Event evt = evtRepo.findByPrettyName(prettyName);
        if (evt == null) throw new EventNotFoundException("Evento " + evt.getTitle() + "não existe");
    ...
    public SubscriptionRankingByUser getRankingByUser(String prettyName, Integer userId) {
        ...
        if (item == null)
            throw new UserInficadorNotFoundExecption("Não há inscrições com indicacao do usuario " + userId);
